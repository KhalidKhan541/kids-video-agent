...
nodes = [
    ...
    {
        "id": "2", "name": "Save Prompts",
        "type": "n8n-nodes-base.httpRequest", "typeVersion": 4.2,
        "position": [470, 300],
        "parameters": {
            "method": "GET",
            "url": "http://localhost:8787/save-prompts",
            "authentication": "none",
    ...
    },
    {
        ...
        "parameters": {
            "method": "GET",
            "url": "http://localhost:8787/open-bing",
            "authentication": "none",
            "options": {"timeout": 5000}
        }
    },
    {
        "id": "4", "name": "Wait Images",
        "type": "n8n-nodes-base.wait", "typeVersion": 1,
        "position": [910, 300],
        "parameters": {
            "resume": "webhook",
            "options": {
                "message": "Create 5 images in Bing, save to input_images/ as scene_01.jpg - scene_05.jpg, then click Resume"
            }
        }
    },
    {
        "id": "5", "name": "Build Video",
        "type": "n8n-nodes-base.httpRequest", "typeVersion": 4.2,
        "position": [1130, 300],
        "parameters": {
            "method": "GET",
            "url": "http://localhost:8787/run-pipeline",
            "authentication": "none",
...
print(f"Workflow created: http://localhost:5678/workflow/{wid}")
